...
_fp8_patch_logger = _logging.getLogger("fp8_z_image_patch")

# ════════════════════════════════════════════════════════════════════════
# 1. FP8 WEIGHT-ONLY PATCH — shared DRY module
# ════════════════════════════════════════════════════════════════════════
try:
