...
# errors until the representation collapses.
#
# Fix: Import shared FP8 weight-only patch and apply to Wan DiT layers.
# ════════════════════════════════════════════════════════════════════════
...
try:
    ...
    # Apply to DiT attention + FFN sublayers (Wan2.2 VACE specific)
    apply_fp8_weight_only_patch(
        layer_filter=lambda prefix, layer: (
            isinstance(layer, _LinearBase)
            and ("ffn" in prefix or "attn" in prefix)
