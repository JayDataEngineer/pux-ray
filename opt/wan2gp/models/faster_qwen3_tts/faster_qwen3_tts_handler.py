...
class family_handler:
    ...
    def query_model_family():
        return "faster_qwen3_tts"

    @staticmethod
    def query_family_infos():
        return {"faster_qwen3_tts": (306, "Faster Qwen3-TTS")}
    ...
    def load_model(model_filename, model_type, base_model_type, model_def,
        ...
        model_path = Path(paths.get("faster_qwen3_tts", ""))
...
class _Pipeline:
    ...
    def generate(self, *, text="", mode="custom_voice", ref_audio_b64=None,
        ...
        buf.seek(0)
        return {"status": "success", "data": base64.b64encode(buf.read()).decode(),
