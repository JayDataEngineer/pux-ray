...
# NOTE: Do NOT change these to match ComfyUI's linear_quadratic scheduler.
# The model was distilled with THIS schedule. Changing it breaks quality.
from ...ltx_core.types import SpatioTemporalScaleFactors

DISTILLED_SIGMA_VALUES = [1.0, 0.99375, 0.9875, 0.98125, 0.975, 0.909375, 0.725, 0.421875, 0.0]

# Reduced schedule for super-resolution stage 2 — matched to WDC 4 steps
STAGE_2_DISTILLED_SIGMA_VALUES = [0.909375, 0.6816, 0.4539, 0.2262, 0.0]
