...
try:
    ...
    flex_gemm = None
    Algorithm = type("_Stub", (), {"EXPLICIT_GEMM": "explicit_gemm"})()
    def sparse_submanifold_conv3d(*a, **kw):
        raise NotImplementedError("flex_gemm not installed — set SPARSE_CONV_BACKEND=spconv")
